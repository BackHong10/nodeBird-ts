...
router.get('/profile', middelwares_1.isLoggedIn, page_1.renderProfile);
router.get('/join', middelwares_1.isNotLoggedIn, page_1.renderJoin);
router.get('/', page_1.renderMain);
router.get('/hashtag', page_1.renderHashtag);
